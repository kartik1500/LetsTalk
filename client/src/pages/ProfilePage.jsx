...
justify-center"
    >
      <div
        className="w-5/6 max-w-2xl backdrop-blur-2x1 text-gray-300 border-2
...
cursor-pointer"
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-purple-400 to-violet-600 text-white p-2 rounded-full text-1g cursor-pointer"
          >
            Save
          </button>
        </form>
